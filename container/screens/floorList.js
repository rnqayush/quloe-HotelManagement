...
const FloorList = (props) => {
    ...
    const delet=(id)=>{
        setData( data.filter((item)=>item.floor_id!=id))


        axios.get(`http://hotel.quloe.info/api/apiManagerDeleteFloor/${id}`).then((res)=>{
    ...
    return (
        <ScrollView showsHorizontalScrollIndicator={false}  >
            ...
            <View style={{ height: 40, width: "100%", backgroundColor: '#E8E8E8', justifyContent: 'center', paddingLeft: 10, marginTop: 20, marginBottom: 20, borderRadius: 5 }}>
                <Text>Home  <Text style={{ color: 'gray' }}>/ Floor List</Text> </Text>
            </View>
            ...
            <View style={{ width: "100%", flexDirection: 'row' }}>
                <View style={{ width: "20%", borderColor: 'lightgray', borderWidth: 1 }}>
                ...
                <View style={{ width: "40%", borderColor: 'lightgray', borderWidth: 1 }}>
                    <View style={[styles.header]}>
...
export default connect(mapStateToProps,null)(FloorList)
